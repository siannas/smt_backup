        ...
        <div class="c-content-panel" style="max-width:500px; margin:auto; background-color:white;">
          <div class="c-body" style="max-width:600px; margin:auto;">
            ...
            <div class="form-group">
                <label for="inputNama" class="col-md-4 control-label">Nama</label>
                <div class="col-md-6">
                  <input type="text" class="form-control  c-square c-theme" id="inputNama" placeholder="Nama">
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group c-margin-t-40 text-center">
                  ...
                  <button type="submit" class="btn c-theme-btn c-btn-square c-btn-uppercase c-btn-bold">Register</button> 
