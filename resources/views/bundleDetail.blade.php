				...
				<div class="col-md-6">
					<div class="c-product-gallery">
						<div class="c-product-gallery-content">
							<div class="c-zoom">
								<img src="{{asset('public/assets/base/img/content/shop8/34.jpg')}}">
							</div>
							<div class="c-zoom">
								<img src="{{asset('public/assets/base/img/content/shop8/35.jpg')}}">
							</div>
							<div class="c-zoom">
								<img src="{{asset('public/assets/base/img/content/shop8/37.jpg')}}">
							</div>
							<div class="c-zoom">
								<img src="{{asset('public/assets/base/img/content/shop8/29.jpg')}}">
							</div>
						</div>
						<div class="row c-product-gallery-thumbnail">
							<div class="col-xs-3 c-product-thumb">
								<img src="{{asset('public/assets/base/img/content/shop/91.jpg')}}">
							</div>
							<div class="col-xs-3 c-product-thumb">
								<img src="{{asset('public/assets/base/img/content/shop/92.jpg')}}">
							</div>
							<div class="col-xs-3 c-product-thumb">
								<img src="{{asset('public/assets/base/img/content/shop/02.jpg')}}">
							</div>
							<div class="col-xs-3 c-product-thumb c-product-thumb-last">
								<img src="{{asset('public/assets/base/img/content/shop/80.jpg')}}">
							</div>
						</div>
					</div>
				</div>
...
<div class="c-content-box c-size-md c-overflow-hide c-bs-grid-small-space">
	<div class="container">
		<div class="c-content-title-4">
			<h3 class="c-font-uppercase c-center c-font-bold c-line-strike"><span class="c-bg-white">Rekomendasi</span></h3>
		</div>
		<div class="row">
			<div data-slider="owl">
					...
					<div class="item">
						<div class="c-content-product-2 c-bg-white c-border">
							<div class="c-content-overlay">
								...
								<div class="c-bg-img-center-contain c-overlay-object" data-height="height" style="height: 270px; background-image: url({{asset('public/assets/base/img/content/shop5/18.png')}});"></div>
							</div>
							<div class="c-info">
					...
					<div class="item">
						<div class="c-content-product-2 c-bg-white c-border">
							<div class="c-content-overlay">
								...
								<div class="c-bg-img-center-contain c-overlay-object" data-height="height" style="height: 270px; background-image: url({{asset('public/assets/base/img/content/shop5/27.png')}});"></div>
							</div>
							<div class="c-info">
					...
					<div class="item">
						<div class="c-content-product-2 c-bg-white c-border">
							<div class="c-content-overlay">
								...
								<div class="c-bg-img-center-contain c-overlay-object" data-height="height" style="height: 270px; background-image: url({{asset('public/assets/base/img/content/shop5/21.png')}});"></div>
							</div>
							<div class="c-info">
					...
					<div class="item">
						<div class="c-content-product-2 c-bg-white c-border">
							<div class="c-content-overlay">
								...
								<div class="c-bg-img-center-contain c-overlay-object" data-height="height" style="height: 270px; background-image: url({{asset('public/assets/base/img/content/shop5/22.png')}});"></div>
							</div>
							<div class="c-info">
					...
					<div class="item">
						<div class="c-content-product-2 c-bg-white c-border">
							<div class="c-content-overlay">
								...
								<div class="c-bg-img-center-contain c-overlay-object" data-height="height" style="height: 270px; background-image: url({{asset('public/assets/base/img/content/shop5/20.png')}});"></div>
							</div>
							<div class="c-info">
					...
					<div class="item">
						<div class="c-content-product-2 c-bg-white c-border">
							<div class="c-content-overlay">
								...
								<div class="c-bg-img-center-contain c-overlay-object" data-height="height" style="height: 270px; background-image: url({{asset('public/assets/base/img/content/shop5/24.png')}});"></div>
							</div>
							<div class="c-info">
								<p class="c-title c-font-18 c-font-slim">Apple iPhone 6+</p>
								<p class="c-price c-font-16 c-font-slim">$548 &nbsp;
