						...
						<div class="col-md-3 col-sm-12 c-image">
							<div class="c-content-overlay">
								...
								<div class="c-bg-img-top-center c-overlay-object" data-height="height">
									<img width="100%" class="img-responsive" src="{{asset('public/assets/base/img/content/shop2/24.jpg')}}">
								</div>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-md-3 col-sm-12 c-image">
							<div class="c-content-overlay">
								...
								<div class="c-bg-img-top-center c-overlay-object" data-height="height">
									<img width="100%" class="img-responsive" src="{{asset('public/assets/base/img/content/shop2/12.jpg')}}">
								</div>
							</div>
						</div>
						<div class="col-md-5 col-sm-8">
